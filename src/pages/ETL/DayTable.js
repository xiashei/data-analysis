...
class EchartPie extends Component{
  // 根据option生成Echart组件
  componentDidUpdate(){
    const charts = echarts.init(document.getElementById(this.props.id));
    const option = new echatOption(this.props.id,this.props.chartsType,this.props.data)
    charts.setOption(option);
    // console.log(this.props.data)
  }

    render() {
    if(this.props.chartsType==='pie'){
    return(
      <div>
...
export default class DayTable extends NPMonthTable{
  // 日表
  constructor(){
    super();
